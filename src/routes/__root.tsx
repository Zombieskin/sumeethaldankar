...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sumeet Haldankar — Senior BA & Product Owner" },
      { property: "og:description", content: "Turning ambiguity into clear, practical outcomes across regulated technology environments." },
    ],
    links: [
